...
/***/ "./src/Controler/Cadastro/CadastroCandidatoController.ts":
/*!***************************************************************!*\
  !*** ./src/Controler/Cadastro/CadastroCandidatoController.ts ***!
  \***************************************************************/
...
"use strict";
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst CandidatoCompetencia_1 = __importDefault(__webpack_require__(/*! ../../modelo/CandidatoCompetencia */ \"./src/modelo/CandidatoCompetencia.ts\"));\nconst UsuarioService_1 = __importDefault(__webpack_require__(/*! ../../service/usuario/UsuarioService */ \"./src/service/usuario/UsuarioService.ts\"));\nconst CandidatoCompetenciaService_1 = __importDefault(__webpack_require__(/*! ../../service/candidato/CandidatoCompetenciaService */ \"./src/service/candidato/CandidatoCompetenciaService.ts\"));\nclass PerfilCandidatoCompetenciaController {\n    constructor() {\n        this.candidatoCompetenciaService = new CandidatoCompetenciaService_1.default();\n        this.usuarioService = new UsuarioService_1.default();\n    }\n    buscarCompetenciaPorId(idCompetencia) {\n        return this.candidatoCompetenciaService.buscarCompetenciaDoCandidatoPorId(idCompetencia);\n    }\n    listarCompetencia() {\n        const idCandidato = this.usuarioService.obterIdUsuarioLogado();\n        return this.candidatoCompetenciaService.listarCompetenciasDoCandidato(idCandidato);\n    }\n    adicionarCompetencias(competencia) {\n        const idCandidato = this.usuarioService.obterIdUsuarioLogado();\n        const candidatoCompetencia = new CandidatoCompetencia_1.default(idCandidato, competencia.nome, competencia.nivel);\n        this.candidatoCompetenciaService.adicionarCompetencia(candidatoCompetencia);\n    }\n    atualizarCompetencia(competenciaAtualizada) {\n        this.candidatoCompetenciaService.atualizarCompetencia(competenciaAtualizada.id, competenciaAtualizada);\n    }\n    excluirCompetencia(idCompetencia) {\n        this.candidatoCompetenciaService.excluirCompetencia(idCompetencia);\n    }\n}\nexports[\"default\"] = PerfilCandidatoCompetenciaController;\n\n\n//# sourceURL=webpack://linketinder/./src/Controler/Candidato/CandidatoCompetenciaController.ts?");

/***/ }),

/***/ "./src/Controler/Candidato/CandidatoController.ts":
/*!********************************************************!*\
  !*** ./src/Controler/Candidato/CandidatoController.ts ***!
  \********************************************************/
...
"use strict";
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst EmpresaService_1 = __importDefault(__webpack_require__(/*! ../../service/empresa/EmpresaService */ \"./src/service/empresa/EmpresaService.ts\"));\nconst UsuarioService_1 = __importDefault(__webpack_require__(/*! ../../service/usuario/UsuarioService */ \"./src/service/usuario/UsuarioService.ts\"));\nclass PerfilEmpresaController {\n    constructor() {\n        this.empresaService = new EmpresaService_1.default();\n        this.usuarioService = new UsuarioService_1.default();\n    }\n    exibirInformacoesEmpresaNoHTML() {\n        const idEmpresa = this.usuarioService.obterIdUsuarioLogado();\n        return this.empresaService.obterEmpresaPorId(idEmpresa);\n    }\n    salvarInformacoesEmpresa(empresa) {\n        const idEmpresa = this.usuarioService.obterIdUsuarioLogado();\n        return this.empresaService.atualizarEmpresa(idEmpresa, empresa);\n    }\n}\nexports[\"default\"] = PerfilEmpresaController;\n\n\n//# sourceURL=webpack://linketinder/./src/Controler/Empresa/PerfilEmpresaController.ts?");

/***/ }),

/***/ "./src/Controler/Empresa/PerfilEmpresaVagasController.ts":
/*!***************************************************************!*\
  !*** ./src/Controler/Empresa/PerfilEmpresaVagasController.ts ***!
  \***************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst UsuarioService_1 = __importDefault(__webpack_require__(/*! ../../service/usuario/UsuarioService */ \"./src/service/usuario/UsuarioService.ts\"));\nconst VagaService_1 = __importDefault(__webpack_require__(/*! ../../service/vaga/VagaService */ \"./src/service/vaga/VagaService.ts\"));\nclass PerfilEmpresaVagasController {\n    constructor() {\n        this.usuarioService = new UsuarioService_1.default();\n        this.vagaService = new VagaService_1.default();\n    }\n    listarVagas() {\n        return this.vagaService.listarVagas();\n    }\n    buscarVagaDaEmpresaPorId(id) {\n        return this.vagaService.buscarVagaDaEmpresaPorId(id);\n    }\n    buscarVagasDaEmpresa() {\n        const idEmpresa = this.usuarioService.obterIdUsuarioLogado();\n        return this.vagaService.buscarVagasDaEmpresa(idEmpresa);\n    }\n    adicionarVaga(vaga) {\n        const idEmpresa = this.usuarioService.obterIdUsuarioLogado();\n        vaga.idEmpresa = idEmpresa;\n        this.vagaService.adicionarVaga(vaga);\n    }\n    atualizarVaga(vaga) {\n        this.vagaService.atualizarVaga(vaga.id, vaga);\n    }\n    excluirVaga(idVaga) {\n        this.vagaService.excluirVaga(idVaga);\n    }\n}\nexports[\"default\"] = PerfilEmpresaVagasController;\n\n\n//# sourceURL=webpack://linketinder/./src/Controler/Empresa/PerfilEmpresaVagasController.ts?");

/***/ }),

/***/ "./src/Controler/Empresa/VagaCompetenciaController.ts":
/*!************************************************************!*\
  !*** ./src/Controler/Empresa/VagaCompetenciaController.ts ***!
  \************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst LoginService_1 = __importDefault(__webpack_require__(/*! ../../service/login/LoginService */ \"./src/service/login/LoginService.ts\"));\nclass LoginController {\n    constructor() {\n        this.loginService = new LoginService_1.default();\n    }\n    loginCandidato(login) {\n        return __awaiter(this, void 0, void 0, function* () {\n            return yield this.loginService.loginCandidato(login);\n        });\n    }\n    loginEmpresa(login) {\n        return __awaiter(this, void 0, void 0, function* () {\n            console.log(login);\n            return yield this.loginService.loginEmpresa(login);\n        });\n    }\n}\nexports[\"default\"] = LoginController;\n\n\n//# sourceURL=webpack://linketinder/./src/Controler/Login/LoginController.ts?");

/***/ }),

/***/ "./src/View/Candidato/CandidatoCompetenciaView.ts":
/*!********************************************************!*\
  !*** ./src/View/Candidato/CandidatoCompetenciaView.ts ***!
  \********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst LoginController_1 = __importDefault(__webpack_require__(/*! ../../Controler/Login/LoginController */ \"./src/Controler/Login/LoginController.ts\"));\nconst LoginDTO_1 = __importDefault(__webpack_require__(/*! ../../modelo/dto/LoginDTO */ \"./src/modelo/dto/LoginDTO.ts\"));\nconst TipoUsuario_1 = __importDefault(__webpack_require__(/*! ../../modelo/enum/TipoUsuario */ \"./src/modelo/enum/TipoUsuario.ts\"));\nclass LoginView {\n    constructor() {\n        this.controller = new LoginController_1.default();\n        this.configurarEventListeners();\n    }\n    configurarEventListeners() {\n        const loginButton = document.getElementById('login');\n        if (loginButton) {\n            loginButton.addEventListener('click', () => {\n                this.login();\n            });\n        }\n    }\n    pegarValoresDoFormulario() {\n        const elements = {\n            email: document.getElementById('email'),\n            senha: document.getElementById('senha')\n        };\n        const login = new LoginDTO_1.default(elements.email.value, elements.senha.value);\n        return login;\n    }\n    pegarTipousuario() {\n        const tipoUsuarioSelect = document.getElementById('userType');\n        const tipoUsuario = tipoUsuarioSelect.value;\n        return tipoUsuario;\n    }\n    login() {\n        const tipoUsuario = this.pegarTipousuario();\n        const login = this.pegarValoresDoFormulario();\n        if (tipoUsuario == TipoUsuario_1.default.Candidato) {\n            this.controller.loginCandidato(login);\n            this.redirecionarParaPerfil(tipoUsuario);\n        }\n        else if (tipoUsuario == TipoUsuario_1.default.Empresa) {\n            console.log(login);\n            this.controller.loginEmpresa(login);\n            this.redirecionarParaPerfil(tipoUsuario);\n        }\n    }\n    redirecionarParaPerfil(tipoUsuario) {\n        if (tipoUsuario === TipoUsuario_1.default.Candidato) {\n            window.location.href = '../../paginas/candidato/vagas-cadastradas/vagas-cadastradas.html';\n        }\n        else if (tipoUsuario === TipoUsuario_1.default.Empresa) {\n            window.location.href = '../../paginas/empresa/candidatos-cadastrados/candidatos-cadastrados.html';\n        }\n    }\n}\nexports[\"default\"] = LoginView;\n\n\n//# sourceURL=webpack://linketinder/./src/View/Login/LoginView.ts?");

/***/ }),

/***/ "./src/View/Vaga/VagaView.ts":
/*!***********************************!*\
  !*** ./src/View/Vaga/VagaView.ts ***!
  \***********************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst CandidatoService_1 = __importDefault(__webpack_require__(/*! ./service/candidato/CandidatoService */ \"./src/service/candidato/CandidatoService.ts\"));\nconst EmpresaService_1 = __importDefault(__webpack_require__(/*! ./service/empresa/EmpresaService */ \"./src/service/empresa/EmpresaService.ts\"));\nconst UsuarioService_1 = __importDefault(__webpack_require__(/*! ./service/usuario/UsuarioService */ \"./src/service/usuario/UsuarioService.ts\"));\nconst CandidatoCompetenciaController_1 = __importDefault(__webpack_require__(/*! ./Controler/Candidato/CandidatoCompetenciaController */ \"./src/Controler/Candidato/CandidatoCompetenciaController.ts\"));\nconst CandidatoCompetenciaView_1 = __importDefault(__webpack_require__(/*! ./View/Candidato/CandidatoCompetenciaView */ \"./src/View/Candidato/CandidatoCompetenciaView.ts\"));\nconst CandidatoCompetenciaService_1 = __importDefault(__webpack_require__(/*! ./service/candidato/CandidatoCompetenciaService */ \"./src/service/candidato/CandidatoCompetenciaService.ts\"));\nconst CandidatoView_1 = __importDefault(__webpack_require__(/*! ./View/Candidato/CandidatoView */ \"./src/View/Candidato/CandidatoView.ts\"));\nconst CandidatoController_1 = __importDefault(__webpack_require__(/*! ./Controler/Candidato/CandidatoController */ \"./src/Controler/Candidato/CandidatoController.ts\"));\nconst CandidatoExperienciaView_1 = __importDefault(__webpack_require__(/*! ./View/Candidato/CandidatoExperienciaView */ \"./src/View/Candidato/CandidatoExperienciaView.ts\"));\nconst CandidatoExperienciaController_1 = __importDefault(__webpack_require__(/*! ./Controler/Candidato/CandidatoExperienciaController */ \"./src/Controler/Candidato/CandidatoExperienciaController.ts\"));\nconst ExperienciaService_1 = __importDefault(__webpack_require__(/*! ./service/candidato/ExperienciaService */ \"./src/service/candidato/ExperienciaService.ts\"));\nconst CandidatoFormacaoView_1 = __importDefault(__webpack_require__(/*! ./View/Candidato/CandidatoFormacaoView */ \"./src/View/Candidato/CandidatoFormacaoView.ts\"));\nconst CandidatoFormacaoController_1 = __importDefault(__webpack_require__(/*! ./Controler/Candidato/CandidatoFormacaoController */ \"./src/Controler/Candidato/CandidatoFormacaoController.ts\"));\nconst FormacaoService_1 = __importDefault(__webpack_require__(/*! ./service/candidato/FormacaoService */ \"./src/service/candidato/FormacaoService.ts\"));\nconst LoginView_1 = __importDefault(__webpack_require__(/*! ./View/Login/LoginView */ \"./src/View/Login/LoginView.ts\"));\nconst PerfilEmpresaView_1 = __importDefault(__webpack_require__(/*! ./View/Empresa/PerfilEmpresaView */ \"./src/View/Empresa/PerfilEmpresaView.ts\"));\nconst VagaView_1 = __importDefault(__webpack_require__(/*! ./View/Vaga/VagaView */ \"./src/View/Vaga/VagaView.ts\"));\nconst VagaCompetenciaController_1 = __importDefault(__webpack_require__(/*! ./Controler/Empresa/VagaCompetenciaController */ \"./src/Controler/Empresa/VagaCompetenciaController.ts\"));\nconst CandidatosCadastradosController_1 = __importDefault(__webpack_require__(/*! ./Controler/Candidato/CandidatosCadastradosController */ \"./src/Controler/Candidato/CandidatosCadastradosController.ts\"));\nconst CadastroCandidatoController_1 = __importDefault(__webpack_require__(/*! ./Controler/Cadastro/CadastroCandidatoController */ \"./src/Controler/Cadastro/CadastroCandidatoController.ts\"));\nconst VagasCadastradasController_1 = __importDefault(__webpack_require__(/*! ./Controler/Empresa/VagasCadastradasController */ \"./src/Controler/Empresa/VagasCadastradasController.ts\"));\nconst CadastroEmpresaController_1 = __importDefault(__webpack_require__(/*! ./Controler/Cadastro/CadastroEmpresaController */ \"./src/Controler/Cadastro/CadastroEmpresaController.ts\"));\nconst candidatoService = new CandidatoService_1.default();\nconst candidatoCompetenciaService = new CandidatoCompetenciaService_1.default();\nconst usuarioService = new UsuarioService_1.default();\nconst empresaService = new EmpresaService_1.default();\nconst experienciaService = new ExperienciaService_1.default();\nconst formacaoService = new FormacaoService_1.default();\nconst vagaCompetenciaController = new VagaCompetenciaController_1.default(usuarioService);\nconst cadastroCandidato = new CadastroCandidatoController_1.default(candidatoService);\nconst cadastroEmpresa = new CadastroEmpresaController_1.default(empresaService);\nconst vagaView = new VagaView_1.default(vagaCompetenciaController);\nvagaView.exibirVagasDaEmpresa();\nconst candidatosCadastradosController = new CandidatosCadastradosController_1.default(candidatoService, usuarioService);\nconst vagasCadastradasController = new VagasCadastradasController_1.default();\nconst controller = new CandidatoFormacaoController_1.default(usuarioService, formacaoService);\nconst candidatoFormacaoVew = new CandidatoFormacaoView_1.default(controller);\ncandidatoFormacaoVew.exibirFormacoesDoCandidato();\nconst candidatoExperienciaController = new CandidatoExperienciaController_1.default(usuarioService, experienciaService);\nconst candidatoExperienciaView = new CandidatoExperienciaView_1.default(candidatoExperienciaController);\ncandidatoExperienciaView.exibirExperienciaDoCandidato();\nconst candidatoController = new CandidatoController_1.default(candidatoService, usuarioService);\nconst candidatoView = new CandidatoView_1.default(candidatoController);\ncandidatoView.exibirInformacoesCandidatoNoHTML();\nconst perfilEmpresaView = new PerfilEmpresaView_1.default();\nperfilEmpresaView.exibirInformacoesEmpresaNoHTML();\nconst perfilCandidatoCompetenciaController = new CandidatoCompetenciaController_1.default();\nconst perfilCandidatoCompetenciaView = new CandidatoCompetenciaView_1.default(perfilCandidatoCompetenciaController);\nperfilCandidatoCompetenciaView.exibirCompetenciasDoCandidato();\nconst loginView = new LoginView_1.default();\n\n\n//# sourceURL=webpack://linketinder/./src/main.ts?");

/***/ }),

/***/ "./src/modelo/Candidato.ts":
/*!*********************************!*\
  !*** ./src/modelo/Candidato.ts ***!
  \*********************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst Pessoa_1 = __importDefault(__webpack_require__(/*! ./Pessoa */ \"./src/modelo/Pessoa.ts\"));\nclass Candidato extends Pessoa_1.default {\n    constructor(nome, email, pais, cep, redeSocial, telefone, descricao, senha, sobrenome, dataNascimento, cpf) {\n        super(nome, email, pais, cep, descricao, senha);\n        this.sobrenome = sobrenome;\n        this.dataNascimento = dataNascimento;\n        this.cpf = cpf;\n        this.redeSocial = redeSocial;\n        this.telefone = telefone;\n        this.competencias = [];\n        this.formacoes = [];\n        this.experiencias = [];\n    }\n    setId(id) {\n        this.id = id;\n    }\n}\nexports[\"default\"] = Candidato;\n\n\n//# sourceURL=webpack://linketinder/./src/modelo/Candidato.ts?");

/***/ }),

/***/ "./src/modelo/CandidatoCompetencia.ts":
/*!********************************************!*\
  !*** ./src/modelo/CandidatoCompetencia.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, exports) => {
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nclass CandidatoCompetencia {\n    constructor(idCandidato, idCompetencia, idNivelCompetencia) {\n        this.idCandidato = idCandidato;\n        this.idCompetencia = idCompetencia;\n        this.idNivelCompetencia = idNivelCompetencia;\n    }\n}\nexports[\"default\"] = CandidatoCompetencia;\n\n\n//# sourceURL=webpack://linketinder/./src/modelo/CandidatoCompetencia.ts?");

/***/ }),

/***/ "./src/modelo/Empresa.ts":
/*!*******************************!*\
  !*** ./src/modelo/Empresa.ts ***!
  \*******************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
eval("\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst Pessoa_1 = __importDefault(__webpack_require__(/*! ./Pessoa */ \"./src/modelo/Pessoa.ts\"));\nclass Empresa extends Pessoa_1.default {\n    constructor(nome, email, pais, cep, descricao, senha, cnpj) {\n        super(nome, email, pais, cep, descricao, senha);\n        this.cnpj = cnpj;\n        this.vagas = [];\n    }\n    setId(id) {\n        this.id = id;\n    }\n}\nexports[\"default\"] = Empresa;\n\n\n//# sourceURL=webpack://linketinder/./src/modelo/Empresa.ts?");

/***/ }),

/***/ "./src/modelo/Experiencia.ts":
/*!***********************************!*\
  !*** ./src/modelo/Experiencia.ts ***!
  \***********************************/
/***/ ((__unused_webpack_module, exports) => {
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nclass Experiencia {\n    constructor(idCandidato, cargo, empresa, nivel) {\n        this.idCandidato = idCandidato;\n        this.cargo = cargo;\n        this.empresa = empresa;\n        this.nivel = nivel;\n    }\n}\nexports[\"default\"] = Experiencia;\n\n\n//# sourceURL=webpack://linketinder/./src/modelo/Experiencia.ts?");

/***/ }),

/***/ "./src/modelo/Formacao.ts":
/*!********************************!*\
  !*** ./src/modelo/Formacao.ts ***!
  \********************************/
/***/ ((__unused_webpack_module, exports) => {
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nclass Formacao {\n    constructor(idCandidato, instituicao, curso, nivel, anoConclusao) {\n        this.idCandidato = idCandidato;\n        this.instituicao = instituicao;\n        this.curso = curso;\n        this.nivel = nivel;\n        this.anoConclusao = anoConclusao;\n    }\n}\nexports[\"default\"] = Formacao;\n\n\n//# sourceURL=webpack://linketinder/./src/modelo/Formacao.ts?");

/***/ }),

/***/ "./src/modelo/Pessoa.ts":
/*!******************************!*\
  !*** ./src/modelo/Pessoa.ts ***!
  \******************************/
/***/ ((__unused_webpack_module, exports) => {
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nclass Pessoa {\n    constructor(nome, email, pais, cep, descricao, senha) {\n        this.nome = nome;\n        this.email = email;\n        this.pais = pais;\n        this.cep = cep;\n        this.descricao = descricao;\n        this.senha = senha;\n    }\n}\nexports[\"default\"] = Pessoa;\n\n\n//# sourceURL=webpack://linketinder/./src/modelo/Pessoa.ts?");
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nclass Vaga {\n    constructor(idEmpresa, nome, descricao, cidade, formacaoMinima, experienciaMinima) {\n        this.idEmpresa = idEmpresa;\n        this.nome = nome;\n        this.descricao = descricao;\n        this.cidade = cidade;\n        this.formacaoMinima = formacaoMinima;\n        this.experienciaMinima = experienciaMinima;\n        this.competencias = [];\n        this.curtida = [];\n    }\n}\nexports[\"default\"] = Vaga;\n\n\n//# sourceURL=webpack://linketinder/./src/modelo/Vaga.ts?");

/***/ }),

/***/ "./src/modelo/VagaCompetencia.ts":
/*!***************************************!*\
  !*** ./src/modelo/VagaCompetencia.ts ***!
  \***************************************/
/***/ ((__unused_webpack_module, exports) => {
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nclass VagaCompetencia {\n    constructor(idVaga, idCompetencia, nivel) {\n        this.idVaga = idVaga;\n        this.idCompetencia = idCompetencia;\n        this.nivel = nivel;\n    }\n}\nexports[\"default\"] = VagaCompetencia;\n\n\n//# sourceURL=webpack://linketinder/./src/modelo/VagaCompetencia.ts?");

/***/ }),

/***/ "./src/modelo/dto/CompetenciaDTO.ts":
/*!******************************************!*\
  !*** ./src/modelo/dto/CompetenciaDTO.ts ***!
  \******************************************/
/***/ ((__unused_webpack_module, exports) => {
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nclass CompetenciaDTO {\n    constructor(nome, nivel) {\n        this.nome = nome;\n        this.nivel = nivel;\n    }\n}\nexports[\"default\"] = CompetenciaDTO;\n\n\n//# sourceURL=webpack://linketinder/./src/modelo/dto/CompetenciaDTO.ts?");

/***/ }),

/***/ "./src/modelo/dto/LoginDTO.ts":
/*!************************************!*\
  !*** ./src/modelo/dto/LoginDTO.ts ***!
  \************************************/
/***/ ((__unused_webpack_module, exports) => {
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nclass LoginDTO {\n    constructor(email, senha) {\n        this.email = email;\n        this.senha = senha;\n    }\n    getEmail() {\n        return this.email;\n    }\n    getSenha() {\n        return this.senha;\n    }\n}\nexports[\"default\"] = LoginDTO;\n\n\n//# sourceURL=webpack://linketinder/./src/modelo/dto/LoginDTO.ts?");

/***/ }),

/***/ "./src/modelo/enum/TipoUsuario.ts":
/*!****************************************!*\
  !*** ./src/modelo/enum/TipoUsuario.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, exports) => {
...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nvar TipoUsuario;\n(function (TipoUsuario) {\n    TipoUsuario[\"Candidato\"] = \"candidato\";\n    TipoUsuario[\"Empresa\"] = \"empresa\";\n})(TipoUsuario || (TipoUsuario = {}));\nexports[\"default\"] = TipoUsuario;\n\n\n//# sourceURL=webpack://linketinder/./src/modelo/enum/TipoUsuario.ts?");

/***/ }),

/***/ "./src/service/candidato/CandidatoCompetenciaService.ts":
/*!**************************************************************!*\
  !*** ./src/service/candidato/CandidatoCompetenciaService.ts ***!
  \**************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst candidatoCompetenciaApi_1 = __importDefault(__webpack_require__(/*! ../../api/candidato/candidatoCompetenciaApi */ \"./src/api/candidato/candidatoCompetenciaApi.ts\"));\nclass CandidatoCompetenciaService {\n    constructor() {\n        this.api = new candidatoCompetenciaApi_1.default();\n    }\n    listarCompetenciasDoCandidato(id) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const response = yield this.api.listarCompetenciasDoCandidato(id);\n            return yield response.data;\n        });\n    }\n    buscarCompetenciaDoCandidatoPorId(id) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const response = yield this.api.buscarCompetenciaDoCandidatoPorId(id);\n            return response.data;\n        });\n    }\n    adicionarCompetencia(competencia) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                yield this.api.criarCompetencia(competencia);\n            }\n            catch (error) {\n                console.error('Erro ao criar candidato:', error);\n            }\n        });\n    }\n    atualizarCompetencia(id, competencia) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                const response = yield this.api.atualizarCompetencia(id, competencia);\n                return true;\n            }\n            catch (_a) {\n                return false;\n            }\n        });\n    }\n    excluirCompetencia(id) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                yield this.api.excluirCompetencia(id);\n                return true;\n            }\n            catch (_a) {\n                return false;\n            }\n        });\n    }\n}\nexports[\"default\"] = CandidatoCompetenciaService;\n\n\n//# sourceURL=webpack://linketinder/./src/service/candidato/CandidatoCompetenciaService.ts?");

/***/ }),

/***/ "./src/service/candidato/CandidatoService.ts":
/*!***************************************************!*\
  !*** ./src/service/candidato/CandidatoService.ts ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst candidatoExperienciaApi_1 = __importDefault(__webpack_require__(/*! ../../api/candidato/candidatoExperienciaApi */ \"./src/api/candidato/candidatoExperienciaApi.ts\"));\nclass ExperienciaService {\n    constructor() {\n        this.api = new candidatoExperienciaApi_1.default();\n    }\n    obterExperienciaDoCandidatoPorId(id) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const response = yield this.api.buscarExperienciaPorId(id);\n            return yield response.data;\n        });\n    }\n    obterExperienciasDoCandidato(candidatoId) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const response = yield this.api.listarExperienciasDoCandidato(candidatoId);\n            return yield response.data;\n        });\n    }\n    adicionarExperienciaAoCandidato(experiencia) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                yield this.api.criarExperiencia(experiencia);\n            }\n            catch (error) {\n                console.log(\"erro ao criar formação: \", error);\n            }\n        });\n    }\n    atualizarExperienciaDoCandidato(id, experiencia) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                yield this.api.atualizarExperiencia(id, experiencia);\n                return true;\n            }\n            catch (_a) {\n                return false;\n            }\n        });\n    }\n    excluirExperienciaDoCandidato(id) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                yield this.api.excluirExperiencia(id);\n                return true;\n            }\n            catch (_a) {\n                return false;\n            }\n        });\n    }\n}\nexports[\"default\"] = ExperienciaService;\n\n\n//# sourceURL=webpack://linketinder/./src/service/candidato/ExperienciaService.ts?");

/***/ }),

/***/ "./src/service/candidato/FormacaoService.ts":
/*!**************************************************!*\
  !*** ./src/service/candidato/FormacaoService.ts ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst candidatoFormacaoApi_1 = __importDefault(__webpack_require__(/*! ../../api/candidato/candidatoFormacaoApi */ \"./src/api/candidato/candidatoFormacaoApi.ts\"));\nclass FormacaoService {\n    constructor() {\n        this.api = new candidatoFormacaoApi_1.default();\n    }\n    obterFormacaoDoCandidatoPorId(id) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const response = yield this.api.buscarFormacaoPorId(id);\n            return yield response.data;\n        });\n    }\n    obterFormacoesDoCandidato(candidatoId) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const response = yield this.api.listarFormacoesDoCandidato(candidatoId);\n            return yield response.data;\n        });\n    }\n    adicionarFormacaoAoCandidato(novaFormacao) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                yield this.api.criarFormacao(novaFormacao);\n            }\n            catch (error) {\n                console.log(\"erro ao criar formação: \", error);\n            }\n        });\n    }\n    atualizarFormacoesDoCandidato(id, formacaoAtualizada) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                yield this.api.atualizarFormacao(id, formacaoAtualizada);\n                return true;\n            }\n            catch (_a) {\n                return false;\n            }\n        });\n    }\n    excluirFormacaoDoCandidato(id) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                yield this.api.excluirFormacao(id);\n                return true;\n            }\n            catch (_a) {\n                return false;\n            }\n        });\n    }\n}\nexports[\"default\"] = FormacaoService;\n\n\n//# sourceURL=webpack://linketinder/./src/service/candidato/FormacaoService.ts?");

/***/ }),

/***/ "./src/service/competencias/CompetenciaService.ts":
/*!********************************************************!*\
  !*** ./src/service/competencias/CompetenciaService.ts ***!
  \********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst competenciaApi_1 = __importDefault(__webpack_require__(/*! ../../api/competencia/competenciaApi */ \"./src/api/competencia/competenciaApi.ts\"));\nclass CompetenciaService {\n    constructor() {\n        this.api = new competenciaApi_1.default();\n    }\n    adicionarCompetencia(nome) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const response = yield this.api.criarCompetencia(nome);\n            return response.data;\n        });\n    }\n    atualizarCompetencia(id, nome) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                const response = yield this.api.atualizarCompetencia(id, nome);\n                return true;\n            }\n            catch (_a) {\n                return false;\n            }\n        });\n    }\n    obterCompetenciaPorId(idCompetencia) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                const response = yield this.api.buscarCompetenciaPorId(idCompetencia);\n                return response.data;\n            }\n            catch (_a) {\n                return undefined;\n            }\n        });\n    }\n    listarCompetencias() {\n        return __awaiter(this, void 0, void 0, function* () {\n            const response = yield this.api.listarCompetencias();\n            return response.data;\n        });\n    }\n    removerCompetencia(idCompetencia) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                yield this.api.excluirCompetencia(idCompetencia);\n                return true;\n            }\n            catch (_a) {\n                return false;\n            }\n        });\n    }\n}\nexports[\"default\"] = CompetenciaService;\n\n\n//# sourceURL=webpack://linketinder/./src/service/competencias/CompetenciaService.ts?");

/***/ }),

/***/ "./src/service/empresa/EmpresaService.ts":
/*!***********************************************!*\
  !*** ./src/service/empresa/EmpresaService.ts ***!
  \***********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst empresaApi_1 = __importDefault(__webpack_require__(/*! ../../api/empresa/empresaApi */ \"./src/api/empresa/empresaApi.ts\"));\nconst cadastroApi_1 = __importDefault(__webpack_require__(/*! ../../api/candidato/cadastroApi */ \"./src/api/candidato/cadastroApi.ts\"));\nclass EmpresaService {\n    constructor() {\n        this.api = new empresaApi_1.default();\n        this.apiCadastro = new cadastroApi_1.default();\n    }\n    listarEmpresas() {\n        return __awaiter(this, void 0, void 0, function* () {\n            const response = yield this.api.listarEmpresas();\n            return response.data;\n        });\n    }\n    obterEmpresaPorId(idEmpresa) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const response = yield this.api.buscarEmpresaPorId(idEmpresa);\n            return response.data;\n        });\n    }\n    adicionarEmpresa(empresa) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                yield this.apiCadastro.criarEmpresa(empresa);\n            }\n            catch (error) {\n                console.error('Erro ao criar candidato:', error);\n            }\n        });\n    }\n    atualizarEmpresa(id, empresa) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                const response = yield this.api.atualizarEmpresa(id, empresa);\n                return true;\n            }\n            catch (_a) {\n                return false;\n            }\n        });\n    }\n    excluirCandidato(idEmpresa) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                yield this.api.excluirEmpresa(idEmpresa);\n                return true;\n            }\n            catch (_a) {\n                return false;\n            }\n        });\n    }\n}\nexports[\"default\"] = EmpresaService;\n\n\n//# sourceURL=webpack://linketinder/./src/service/empresa/EmpresaService.ts?");

/***/ }),

/***/ "./src/service/login/LoginService.ts":
/*!*******************************************!*\
  !*** ./src/service/login/LoginService.ts ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst loginAPI_1 = __importDefault(__webpack_require__(/*! ../../api/login/loginAPI */ \"./src/api/login/loginAPI.ts\"));\nclass LoginService {\n    constructor() {\n        this.api = new loginAPI_1.default();\n    }\n    loginCandidato(login) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const response = yield this.api.LoginCandidato(login);\n            const candidatoId = response.data;\n            this.salvarIdNoLocalStorage(candidatoId);\n            return candidatoId;\n        });\n    }\n    loginEmpresa(login) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const response = yield this.api.LoginEmpresa(login);\n            const empresaId = response.data;\n            console.log(empresaId);\n            this.salvarIdNoLocalStorage(empresaId);\n            return empresaId;\n        });\n    }\n    salvarIdNoLocalStorage(id) {\n        localStorage.setItem('usuarioId', id.toString());\n    }\n}\nexports[\"default\"] = LoginService;\n\n\n//# sourceURL=webpack://linketinder/./src/service/login/LoginService.ts?");

/***/ }),

/***/ "./src/service/usuario/UsuarioService.ts":
/*!***********************************************!*\
  !*** ./src/service/usuario/UsuarioService.ts ***!
  \***********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst vagaCompetenciaApi_1 = __importDefault(__webpack_require__(/*! ../../api/vaga/vagaCompetenciaApi */ \"./src/api/vaga/vagaCompetenciaApi.ts\"));\nclass VagaCompetenciaService {\n    constructor() {\n        this.api = new vagaCompetenciaApi_1.default();\n    }\n    listarCompetencias(id) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const response = yield this.api.listarCompetencias(id);\n            return response.data;\n        });\n    }\n    buscarCompetenciaPorId(id) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const response = yield this.api.buscarCompetenciaPorId(id);\n            return response.data;\n        });\n    }\n    criarCompetencia(competencia) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                yield this.api.criarCompetencia(competencia);\n            }\n            catch (error) {\n                console.error('Erro ao criar candidato:', error);\n            }\n        });\n    }\n    atualizarCompetencia(id, competencia) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                const response = yield this.api.atualizarCompetencia(id, competencia);\n                return true;\n            }\n            catch (_a) {\n                return false;\n            }\n        });\n    }\n    excluirCandidato(id) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                yield this.api.excluirCompetencia(id);\n                return true;\n            }\n            catch (_a) {\n                return false;\n            }\n        });\n    }\n}\nexports[\"default\"] = VagaCompetenciaService;\n\n\n//# sourceURL=webpack://linketinder/./src/service/vaga/VagaCompetenciaService.ts?");

/***/ }),

/***/ "./src/service/vaga/VagaService.ts":
/*!*****************************************!*\
  !*** ./src/service/vaga/VagaService.ts ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
"use strict";
eval("\nvar __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __importDefault = (this && this.__importDefault) || function (mod) {\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\n};\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst UsuarioService_1 = __importDefault(__webpack_require__(/*! ../usuario/UsuarioService */ \"./src/service/usuario/UsuarioService.ts\"));\nconst vagaApi_1 = __importDefault(__webpack_require__(/*! ../../api/vaga/vagaApi */ \"./src/api/vaga/vagaApi.ts\"));\nconst CandidatoService_1 = __importDefault(__webpack_require__(/*! ../candidato/CandidatoService */ \"./src/service/candidato/CandidatoService.ts\"));\nclass VagaService {\n    constructor() {\n        this.api = new vagaApi_1.default;\n        this.candidatoService = new CandidatoService_1.default();\n        this.usuarioService = new UsuarioService_1.default();\n    }\n    listarVagas() {\n        return __awaiter(this, void 0, void 0, function* () {\n            const response = yield this.api.listarVagas();\n            return response.data;\n        });\n    }\n    buscarVagaDaEmpresaPorId(idEmpresa) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const response = yield this.api.buscarVagaDaEmpresaPorId(idEmpresa);\n            return response.data;\n        });\n    }\n    buscarVagasDaEmpresa(idEmpresa) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const response = yield this.api.buscarVagasDaEmpresa(idEmpresa);\n            return response.data;\n        });\n    }\n    adicionarVaga(vaga) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                yield this.api.criarVaga(vaga);\n            }\n            catch (error) {\n                console.error('Erro ao criar candidato:', error);\n            }\n        });\n    }\n    atualizarVaga(id, vaga) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                const response = yield this.api.atualizarVaga(id, vaga);\n                return true;\n            }\n            catch (_a) {\n                return false;\n            }\n        });\n    }\n    excluirVaga(idEmpresa) {\n        return __awaiter(this, void 0, void 0, function* () {\n            try {\n                yield this.api.excluirVaga(idEmpresa);\n                return true;\n            }\n            catch (_a) {\n                return false;\n            }\n        });\n    }\n    calcularAfinidadeVagaComCandidato(vaga) {\n        return __awaiter(this, void 0, void 0, function* () {\n            const idCandidato = this.usuarioService.obterIdUsuarioLogado();\n            const candidatoLogado = yield this.candidatoService.obterCandidatoPorId(idCandidato);\n            if (!candidatoLogado) {\n                return 0;\n            }\n            const afinidadeCompetencias = this.calcularAfinidadeCompetencias(vaga, candidatoLogado);\n            const afinidadeExperiencia = this.calcularAfinidadeExperiencia(vaga, candidatoLogado);\n            const afinidadeFormacao = this.calcularAfinidadeFormacao(vaga, candidatoLogado);\n            const maxAfinidade = (3 * vaga.competencias.length) + 3 + 3;\n            const afinidadeTotal = afinidadeCompetencias + afinidadeExperiencia + afinidadeFormacao;\n            const afinidadePercentual = (afinidadeTotal / maxAfinidade) * 100;\n            return afinidadePercentual;\n        });\n    }\n    calcularAfinidadeCompetencias(vaga, candidato) {\n        let afinidade = 0;\n        vaga.competencias.forEach(requisito => {\n            const competenciaCandidato = candidato.competencias.find(competencia => competencia.idNivelCompetencia === requisito.nivel);\n            if (competenciaCandidato && competenciaCandidato.idNivelCompetencia === requisito.nivel) {\n                afinidade += 3;\n            }\n        });\n        return afinidade;\n    }\n    calcularAfinidadeExperiencia(vaga, candidato) {\n        const experienciaCandidato = candidato.experiencias.find(experiencia => experiencia.nivel === vaga.experiencia.nivel);\n        return experienciaCandidato ? 3 : 0;\n    }\n    calcularAfinidadeFormacao(vaga, candidato) {\n        const formacaoCandidato = candidato.formacoes.find(formacao => formacao.nivel === vaga.formacao.nivel);\n        return formacaoCandidato ? 3 : 0;\n    }\n}\nexports[\"default\"] = VagaService;\n\n\n//# sourceURL=webpack://linketinder/./src/service/vaga/VagaService.ts?");
...
eval("const chartjs = __webpack_require__(/*! ../dist/chart.cjs */ \"./node_modules/chart.js/dist/chart.cjs\");\nconst {Chart, registerables} = chartjs;\n\nChart.register(...registerables);\n\nmodule.exports = Object.assign(Chart, chartjs);\n\n\n//# sourceURL=webpack://linketinder/./node_modules/chart.js/auto/auto.cjs?");

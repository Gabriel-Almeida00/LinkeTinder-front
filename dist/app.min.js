...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nconst uuid_1 = __webpack_require__(/*! uuid */ \"./node_modules/uuid/dist/commonjs-browser/index.js\");\nclass Competencia {\n    constructor(nome) {\n        this.id = (0, uuid_1.v4)();\n        this.nome = nome;\n    }\n    obterNome() {\n        return this.nome;\n    }\n    obterId() {\n        return this.id;\n    }\n}\nexports[\"default\"] = Competencia;\n\n\n//# sourceURL=webpack://linketinder/./src/modelo/Competencia.ts?");
